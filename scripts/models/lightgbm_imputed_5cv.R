...
# ---- Step 5: Loop Through Folds (Imputation, Undersampling, Training, Evaluation) ----
for (i in 1:length(folds)) {
  ...
  # =================================================================
  # BUG FIX & REORDERING: IMPUTATION IS NOW DONE *BEFORE* UNDERSAMPLING
  # =================================================================
  ...
  # --- Step 5.3: Prepare LightGBM Data Matrices ---
  ...
  # --- Step 5.4: Train the LightGBM Model ---
  params <- list(
  ...
  # --- Step 5.5: Evaluate on TEST data only ---
